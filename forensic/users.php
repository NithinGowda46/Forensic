				...
				<div class="container">
						...
						<div class="col-lg-4 single-services">
							<div class="card text-center" style="width: 18rem;">
								...
								<div class="card-body">
									...
									<a href="" class="btn btn-primary" data-toggle="modal" data-target="#myModal1" > Go  </a>
								</div>
							</div>
						</div>
						...
						<div class="col-lg-4 single-services">
							<div class="card text-center" style="width: 18rem;">
								...
								<div class="card-body">
									...
									<a href="" class="btn btn-primary" data-toggle="modal" data-target="#myModal3"> Go  </a>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-4 single-services">
							<div class="card text-center" style="width: 18rem;">
								<img style="height:225px; width:225px" class="card-img-top mx-auto" src="img/write.jpg" alt="Card image cap">
								<div class="card-body">
									<h5 class="card-title"> Remove Officer </h5>
									<p class="card-text">  Remove Officer Details</p>
						...
						<div class="col-lg-4 single-services">
							<div class="card text-center" style="width: 18rem;">
								...
								<div class="card-body">
									...
									<a href="logs.php" class="btn btn-primary" data-toggle="modal" data-target="#myModal5"> Go  </a>
								</div>
							</div>
						</div>
						...
						<div class="col-lg-4 single-services">
							<div class="card text-center" style="width: 18rem;">
								...
								<div class="card-body">
									...
									<a href="logs.php" class="btn btn-primary" data-toggle="modal" data-target="#myModal6"> Go  </a>
								</div>
							</div>
						</div>
					</div>
										...
										<div class="modal-body">
											<form action="usersdelete.php" method="POST">
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="OFFICER_ID" name="delofficer" required = "true">
												</div>
												<div class="modal-footer">
													<button type="button" class="btn btn-secondary" data-dismiss="modal"> Close </button>
													<button type="submit" name="submit" class="btn btn-primary"> Enter </button>																								
							...
							<!-- Modal -->
							<div class="modal fade"  style="padding-top:10%;" id="myModal5" role="dialog">
								<div class="modal-dialog">
									<div class="modal-content">
										<div class="modal-header">
										...
										<div class="modal-body">
											<form action="usersdelete.php" method="POST">
												<div class="form-group">
													<label> Lab Id </label>
													<input type="text" class="form-control" placeholder="Lab_Id" name="dellab" required = "true">
												</div>
												<div class="modal-footer">
													<button type="button" class="btn btn-secondary" data-dismiss="modal"> Close </button>
													<button type="submit" name="submit" class="btn btn-primary"> Enter </button>																								
							...
							<div class="modal fade"  style="padding-top:10%;" id="myModal6" role="dialog">
								<div class="modal-dialog">
									<div class="modal-content">
										<div class="modal-header">
